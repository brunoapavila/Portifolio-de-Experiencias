...
![Visitors](https://komarev.com/ghpvc/?username=brunoapavila&color=blue&style=flat-square&label=Visitors)
...
**Analista SRE / Monitoramento & Observabilidade** · Keeggo *(12/2022 – 11/2024)*
> Implementação de soluções com Dynatrace, Datadog e Broadcom. Terraform/Ansible em AWS e GCP. Definição de SLAs, SLOs, SLIs e KPIs. Análise de incidentes, RCA, Postmortem e Runbook.
...
Especializar-me progressivamente em QA com foco em segurança de software — **AppSec**, **DevSecOps**, **Blue Team** — tornando a qualidade e a segurança um valor cultural dentro das organizações.
